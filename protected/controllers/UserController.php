...
class UserController extends Controller
{
	...
	public function filterNotAuthorize($filter) {
	...
	public function actionCreate()
	{
		...
		{	
			...
			if($model->save()) {
				...
				$labs->save();
				Yii::app()->user->setFlash('create','User telah berhasil dibuat');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['User']))
		{
			...
			if($model->save()) {
				Yii::app()->user->setFlash('update','User telah berhasil diupdate');
				$this->redirect(array('view','id'=>$model->id));
			}
		}
	...
	{
		$dataProvider=new CActiveDataProvider('User',array('sort'=>array('defaultOrder'=>'id ASC')));
