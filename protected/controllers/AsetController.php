...
class AsetController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Aset']))
		{
			...
			$model->id_lab = $lab->id;
			if($model->save()){
				Yii::app()->user->setFlash('create','Aset berhasil ditambahkan');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Aset']))
		{
			$model->attributes=$_POST['Aset'];
			if($model->save()){
				Yii::app()->user->setFlash('update','Aset berhasil diperbaharui');
				$this->redirect(array('view','id'=>$model->id));
			}
		}
	...
	public function actionAdmin()
	{
		...
		$labs = Lab::model()->find("id_ketua=".Yii::app()->user->id);
		
		$dataProvider=new CActiveDataProvider('Aset', array(
				'criteria' => array(
					'condition'=>'id_lab='.$labs->id,
				)
		));
