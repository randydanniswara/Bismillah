...
class LabUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_lab', 'required'),
			array('id_user, id_lab', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_user, id_lab', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'lab' => array(self::BELONGS_TO, 'Department', 'departmentId'),
		);
	}
