...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('samePassword','length','min'=>6,'message'=>'Password terlalu singkat'),
			array('samePassword','compare','compareAttribute'=>'password','message'=>'Password tidak sesuai'),
	...
	protected function beforeSave() {
		///echo strlen($this->password);return;
		
		if (strlen($this->password) == 0){
			$this->password = $this->oldPassword;
			$this->samePassword = $this->oldPassword;
		} else {
